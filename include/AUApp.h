...
#	define AUApp_linkToDefaultAVCapture(APP)		(0) //NBMngrAVCapture::setGlue(APP, AUAppGlueAndroidAVCapture::create)
...
#	define AUApp_linkToDefaultAVCapture(APP)		(0) //NBMngrAVCapture::setGlue(APP, AUAppGlueIOSAVCapture::create)
